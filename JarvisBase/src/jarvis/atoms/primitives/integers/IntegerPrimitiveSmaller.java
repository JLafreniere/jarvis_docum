...
/*
* Cette classe implante la partie de l'opération primitive plus petit.
* 
*/

public class IntegerPrimitiveSmaller extends IntegerPrimitiveOperation {

	@Override
	public String makeKey() {

		return "IntegerPrimitiveSmaller";
	}
